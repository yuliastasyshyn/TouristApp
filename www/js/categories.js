document.addEventListener("DOMContentLoaded", function () {
    ...
    var landmarkMarkers = landmarks.map(place => addMarker(landmarksLayer, place.coords[0], place.coords[1], place.name, place.url));
    var restaurantMarkers = restaurants.map(place => addMarker(restaurantsLayer, place.coords[0], place.coords[1], place.name, place.url));
    var shoppingMarkers = shoppingPlaces.map(place => addMarker(shoppingLayer, place.coords[0], place.coords[1], place.name, place.url));
