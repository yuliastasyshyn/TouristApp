...
function onDeviceReady() {
    ...
    // Ініціалізація мапи після готовності пристрою
    var map = L.map('map').setView([49.8383, 24.0232], 13); // Центр Львова
...
document.getElementById('continueBtn').addEventListener('click', function() {
    // Продовжуємо без реєстрації
    alert('Продовжуємо без реєстрації');
    window.location.href = 'map.html';
});

// Логіка для кнопки "Переглянути карту"
